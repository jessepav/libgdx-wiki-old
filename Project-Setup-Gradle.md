...
This will create a gradle ready project, which can then be imported into your IDE (Android Studio, Eclipse..). Please note that projects generated by the Setup Tool are _not_ compatible with Java 14 due to Gradle incompatibilities.
