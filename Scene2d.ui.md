...
Skin files from [gdx-tools](https://github.com/libgdx/libgdx/tree/master/extensions/gdx-tools/assets) can be used as a starting point. You will need: uiskin.png, uiskin.atlas, uiskin.json, and default.fnt. This enables you to quickly get started using scene2d.ui and replace the skin assets later.
