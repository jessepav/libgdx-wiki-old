...
I took the assets from the following sources:
  ...
  * droplet sprite by mvdv, see [link](https://github.com/Quillraven/SimpleKtxGame/blob/01-app/android/assets/images/drop.png?raw=true)
  * bucket sprite by mvdv, see [link](https://github.com/Quillraven/SimpleKtxGame/blob/01-app/android/assets/images/bucket.png?raw=true)
